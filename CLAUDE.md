...
- **Callback dispatch** is prefix-based: `provider:`, `deep:`, `quick:`, `info:`, `multi:`, `wsel:` (bulk select-all/clear), `wpage:` (pagination prev/next/noop), `runall:`, `del:`, `cancel:`, `cancel_analysis:`, `hist:`, `hist_t:`, `hist_back:`. Order matters where prefixes overlap (`cancel_analysis:` is checked before `cancel:`). Stay under Telegram's 64-byte `callback_data` limit.
